...
from models.flux_text_encoder import SD3TextEncoder1,FluxTextEncoder2
from models.flux_vae import FluxVAEEncoder, FluxVAEDecoder


from configs.model_config import model_loader_configs, huggingface_model_loader_configs, patch_model_loader_configs
from models.utils import load_state_dict, load_state_dict_from_folder, init_weights_on_device, hash_state_dict_keys, split_state_dict_with_prefix
import glob
...
class ModelManager:
    ...
    def load_model(self, file_path, model_names=None, device=None, torch_dtype=None):
        ...
        if isinstance(file_path, list):
            ...
            state_dict = load_state_dict_from_folder(file_path)
        else:
            state_dict = None
